...
const RMDashboard = () => {
  const aumData = [
    ...
    { strategy: "Debt", aum: "₹670 Cr", change: "+5.2%", color: "text-green-600" },
    { strategy: "Balanced", aum: "₹450 Cr", change: "+6.8%", color: "text-green-600" },
  ];

  const alerts = [
    { id: 1, type: "KYC Expiring", customer: "Rajesh Sharma", priority: "High", status: "pending" },
    { id: 2, type: "Mandate Renewal", customer: "Priya Patel", priority: "Medium", status: "pending" },
    { id: 3, type: "SIP Failed", customer: "Amit Verma", priority: "High", status: "action" },
    { id: 4, type: "Document Missing", customer: "Sunita Reddy", priority: "Low", status: "pending" },
  ];
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">₹45 Cr monthly</p>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">Onboarding in Progress</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">Fund Transfer Pending</span>
              ...
              <TableBody>
                {topCustomers.map((customer, idx) => (
                  <TableRow key={idx}>
                    ...
                    <TableCell className="text-green-600">{customer.returns}</TableCell>
                    <TableCell>
